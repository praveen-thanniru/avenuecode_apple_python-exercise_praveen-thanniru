    ...
    **kwargs
    ...
    if scaleratio is None:
        ...
        layout = graph_objs.Layout(
            hovermode="closest",
            yaxis=dict(scaleratio=scaleratio, scaleanchor="x"),
        )
...
class _Quiver(object):
    ...
    def get_quiver_arrows(self):
        ...
        for index in range(len(barb_len)):
            barb_len[index] = math.hypot(
                dif_x[index] / self.scaleratio, dif_y[index]
            )
        ...
        for index in range(len(barb_ang)):
            barb_ang[index] = math.atan2(
                dif_y[index], dif_x[index] / self.scaleratio
            )
