...
histogram.__doc__ = make_docstring(
    ...
    append_dict=dict(
        x=[
            "If `orientation` is `'h'`, these values are used as inputs to `histfunc`."
        ]
        + _wide_mode_xy_append,
        y=[
            "If `orientation` is `'v'`, these values are used as inputs to `histfunc`."
        ]
        + _wide_mode_xy_append,
        histfunc=[
...
def density_mapbox(
    ...
    return make_figure(
        ...
        trace_patch=dict(radius=radius),
    )
