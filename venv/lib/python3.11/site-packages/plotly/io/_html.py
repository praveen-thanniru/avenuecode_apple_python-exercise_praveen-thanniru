...
def to_html(
    ...
    template_dict = (
        fig_dict.get("layout", {}).get("template", {}).get("layout", {})
    )
...
""".format(
            plotly_platform_url=config.get(
    ...
    elif isinstance(include_plotlyjs, str) and include_plotlyjs.endswith(
        ".js"
    ):
        load_plotlyjs = """\
        {win_config}
...
def write_html(
    ...
    if isinstance(file, str):
        ...
        file, Path
    ):  # PurePath is the most general pathlib object.
