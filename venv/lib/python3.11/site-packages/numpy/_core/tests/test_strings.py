...
class TestMethods:
    ...
    @pytest.mark.parametrize(
        "i_dt", [np.int8, np.int16, np.int32, np.int64, np.int_]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("", "xx", MAX, 0, -1),
            pytest.param(
                99 * "a" + "b", "b", 0, None, 99, id="99*a+b-b-0-None-99"
            ),
            pytest.param(
                98 * "a" + "ba", "ba", 0, None, 98, id="98*a+ba-ba-0-None-98"
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("aaa", "aaaa", 0, None, 0),
            pytest.param(
                98 * "a" + "ba", "ba", 0, None, 1, id="98*a+ba-ba-0-None-1"
            ),
            pytest.param(
                30000 * "a" + 100 * "b",
                100 * "b",
