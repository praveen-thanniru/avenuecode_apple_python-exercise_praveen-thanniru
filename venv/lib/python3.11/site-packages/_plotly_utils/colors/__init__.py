...
def sample_colorscale(
    colorscale, samplepoints, low=0.0, high=1.0, colortype="rgb"
):
    """
    ...
    if isinstance(samplepoints, int):
        samplepoints = [
            low + idx / (samplepoints - 1) * (high - low)
            for idx in range(samplepoints)
        ]
    ...
    for point in samplepoints:
        ...
        sampled_color = find_intermediate_color(
            colors[low], colors[high], interpolant
        )
